...
public class flower_kit extends Item {
	
	public static final PropertyDirection FACING = PropertyDirection.create("facing");
	
	public flower_kit() {
		this.setRegistryName("flower_kit");
		this.setUnlocalizedName("flower_kit");
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if(!worldIn.isRemote) {
			...
			if(block == random_objects_main.wheel_barrows_dirt) {
				worldIn.setBlockState(pos, random_objects_main.wheel_barrows_tulip.getDefaultState().withProperty(FACING, facing));
